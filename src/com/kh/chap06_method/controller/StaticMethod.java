...
public class StaticMethod {
	...
	// 1. 매개변수도 없고 반환값도 없는 매소드
	public static void method1() {
		System.out.println("매개변수와 반환값 둘 다 없는 static메소드입니다.");
	}
	
	// 2. 매개변수 없고 반환값은 있는 매소드
	public static int method2() {
		System.out.println("매개변수 없고 반환값은 있는 static메소드입니다.");
		
		// 1부터 랜덤값(1~100 사이의)까지의 총 합계
		/*
		int sum = 0;
	...
	// 4. 매개변수 있고 반호나값도 있는 메소드
	public static boolean method4(String str1, String str2) {
		System.out.println("매개변수와 반환값 둘 다 있는 static메소드입니다.");
		/*
